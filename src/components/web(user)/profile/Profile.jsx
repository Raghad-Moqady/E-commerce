  ...
  if(loading){
   ...
   return (
    ...
    <div className="row flex-nowrap">
      <div className={`col-auto col-md-5 col-xl-2 px-sm-2 px-0  ${style.sidebar} `}>
        <div className={`${style.leftSide} d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white `}>
          <Link to='/profile' className="d-flex gap-3 align-items-center pb-3 mb-md-0 me-md-auto text-black m-auto text-decoration-none">
            <h1 className=" d-sm-inline">Profile</h1>
          </Link>
          <ul className={`${style.list} nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start`} >
            <li className="nav-item">
              <Link to='/' className="nav-link align-middle px-0">
                <i className="fs-4 bi-house" /> <span className=" text-black ms-1 d-none d-sm-inline">Home</span>
              </Link>
            </li>   
            <li>
              <Link to='' className="nav-link px-0 align-middle">
                <i className="fs-4 bi-table" /> <span className="text-black ms-1 d-none d-sm-inline">Information</span></Link>
            </li>
            <li>
              <Link to='contact' className="nav-link px-0 align-middle">
                <i className="fs-4 bi-table" /> <span className="text-black ms-1 d-none d-sm-inline">Contact</span></Link>
            </li>
            <li>
              <Link to='orders' className="nav-link px-0 align-middle">
                <i className="fs-4 bi-table" /> <span className="text-black ms-1 d-none d-sm-inline">Orders</span></Link>
            </li>
            <li>
              <Link to='accountDetails' className="nav-link px-0 align-middle">
                <i className="fs-4 bi-table" /> <span className="text-black ms-1 d-none d-sm-inline">Account Details</span></Link>
            </li>
          </ul>
          <hr />
